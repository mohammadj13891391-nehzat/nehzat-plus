...
namespace EducationalPlatform.Nehzat.Application.Interfaces
{
    public interface IExperimentalSciencesService
    {
        ...
        Task<Phase?> FindPhaseByIdAsync(int id);
        ...
        Task<Topic?> FindTopicByIdAsync(int id);
        ...
        Task<Lesson?> FindLessonByIdAsync(int id);
        ...
        Task<Experiment?> FindExperimentByIdAsync(int id);
        ...
        Task<Quiz?> FindQuizByLessonIdAsync(int lessonId);
        ...
        Task<QuizQuestion?> FindQuizQuestionByIdAsync(int id);
        ...
        Task<StudentProgress?> FindStudentProgressByIdAsync(int id);
