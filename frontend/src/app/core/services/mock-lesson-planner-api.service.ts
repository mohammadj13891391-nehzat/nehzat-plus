...
export class MockLessonPlannerApi extends LessonPlannerApi {
  ...
  private seedSurveyData(): void {
    ...
    const categories = [
      { name: 'والدین و خانواده', count: 26,
        questions: [
          'به نظر شما تعامل والدین با دانش‌آموز باعث بهبود عملکرد تحصیلی می‌شود؟',
          ...
          'دانش‌آموز بین والدین و دوستان تعادل برقرار می‌کند؟',
          ...
          'ارتباط والدین با دانش‌آموز درباره مدرسه روزانه است؟',
          'والدین اختصاص فضای آرام مطالعه در خانه فراهم می‌کنند؟',
          'انضباط خانوادگی بر تحصیل دانش‌آموز تأثیر دارد؟',
          'والدین از برك تحصیلی دانش‌آموز کمک می‌گیرند؟',
          'توقع والدین از نمره با واقعیت تطابق دارد؟',
          'والدین نگران سلامت روان دانش‌آموز هستند؟',
          'تعهد خانوادگی به برنامه روزانه دانش‌آموز کافی است؟',
          'والدین از شما خواسته‌های میشاند را شنیده باشند؟',
          'تعامل سالم بین برادران و خواهران بر تحصیل اثر گذاشته؟',
          'والدین از دانش‌آموز انتظار مشخصی دارند؟',
          'پشتوانه مالی خانواده بر نیازهای تحصیلی دانش‌آموز کافی است؟',
          'والدین از رشته‌های هنری و ورزشی حمایت می‌کنند؟',
          'ارتباط دانش‌آموز با والدین در مورد مشکلات مدرسه است؟',
          'والدین از تکالیف روزانه دانش‌آموز کنترل کافی دارند؟'
        ]
      },
      { name: 'سازماندهی و مستندسازی', count: 28,
        questions: [
          ...
          'برنامه هفتگی تحصیلی دانش‌آموز وجود دارد؟',
          ...
          'تکالیف ویژه دانش‌آموزان با نیازهای ویژه پیش‌بینی شده؟',
      ...
      { name: 'منابع مالی و مشاوره', count: 7,
        questions: [
          ...
          'کمک‌های مالی بورسیه و ارزشیابی دانش‌آموزان کافی است؟',
      ...
      { name: 'آموزشی', count: 30,
        questions: [
          ...
          'بازخورد مستمر نمرات و پیشرفت دانش‌آموزی ارائه می‌شود؟',
          'اختصاص زمان کافی برای مرور و تمرین در کلاس؟',
          'منابع آموزشی الکترونیکی و آنلاین برای دانش‌آموزان فراهم است؟',
          'کلاس‌های کمکی برای دانش‌آموزان دارای نیازهای ویژه برگزار می‌شود؟',
          ...
          'تدریس اصول آموزشی و فلسفه آموزش به دانش‌آموزان؟',
          'فعالیت‌های عملی و آزمایشگاهی برای علوم تجربی کافی است؟',
          'ارائه تکالیف پروژه‌ای و بحث‌گروهی در کلاس‌ها؟',
          'تست‌های اختلاط‌شده و چند سطحی برای بررسی دانش‌آموزان؟',
          'امتحانات عملی و کاربردی علاوه بر نوشتاری؟',
          'ارائه فیدبک فوری و بندهای بهبود به دانش‌آموزان؟',
      ...
      { name: 'خط و خوشنویسی', count: 15,
        questions: [
          ...
          'برگزاری نمایشگاه خوشنویسی دانش‌آموزان؟',
          'آرشیو نمونه‌های خط هر دانش‌آموز؟',
      ...
      { name: 'ارتباطات', count: 18,
        questions: [
          ...
          'گزارش هفتگی یا ماهانه پیشرفت دانش‌آموز؟',
          'ارتباط مجازی مکتب با والدین (گروه پیام)?',
          'سیستم پیگیری مشکلات دانش‌آموزی از طریق ارتباط؟',
      ...
      { name: 'معلمان', count: 20,
        questions: [
          ...
          'پاسخگویی معلمان به سؤالات دانش‌آموزان؟',
          'تشویق و انگیزه‌بخشی معلمان؟',
          'عدالت و صداقت در نمره‌دهی؟',
          'تمایز معلمان با دانش‌آموزان در کلاس؟',
          'توجه به نیازهای فردی هر دانش‌آموز؟',
          ...
          'نحوه یادگیری دانش‌آموزان از روش تدریس معلمان؟',
          'پاسخ‌گویی سریع به شکایات دانش‌آموزان و والدین؟',
          'تشخیص و رسیدگی به مشکلات یادگیری دانش‌آموزان؟',
          'آزادی و استقلال فکری در کلاس آموزشی؟',
          'ارائه بازخورد بنّاء به دانش‌آموزان؟',
          'توجه به دانش‌آموزان با توانایی‌های متفاوت؟',
          'تعهد و مسئولیت‌پذیری معلمان در تدریس؟'
        ]
      },
      { name: 'آموزجوها', count: 12,
        questions: [
          'تعداد دانش‌آموزان به اندازه بودجه خوب قابل مدیریت است؟',
          ...
          'پشتیبانی مالی برای فعالیت‌های دانش‌آموزی از سوی مکتب؟',
          ...
          'تعهد مکتب به رشد و پیشرفت تحصیلی دانش‌آموزان؟'
        ]
      },
      { name: 'متغیرهای دیگر', count: 8,
        questions: [
          ...
          'امکانات دسترسی برای دانش‌آموزان از کم‌توانیان؟',
          'خدمات حمل‌ونقل و اتوبوس مکتب؟',
          'تجهیزات و تجهیزات ورزشی کافی؟',
          'فضای سبز و استراحت مناسب؟',
          'نرخ رشد و نرخ تعداد دانش‌آموزان مکتب در چند سال اخیر؟'
        ]
      }
    ];
    ...
    for (const cat of categories) {
      for (let i = 0; i < cat.questions.length; i++) {
        this.issueQuestions.push({
          id: qId++,
          surveyId: 1,
          questionText: cat.questions[i],
          category: cat.name,
          subCategory: '',
          targetAudience: 'دانش‌آموز',
          sortOrder: i,
          isActive: true,
          createdAt: now
        });
    ...
    for (let r = 0; r < respondentNames.length; r++) {
      ...
      for (let i = 0; i < responsesPerRespondent && i < this.issueQuestions.length; i++) {
        const qIndex = (respondentId * 7 + i * 13) % this.issueQuestions.length;
        const question = this.issueQuestions[qIndex];
        if (!question) continue;

        const score = this.generateLikertScore(question.category);
        this.issueResponses.push({
          id: this.nextId(this.issueResponses) + i,
          surveyId: 1,
  ...
  private generateLikertScore(category: string): number {
